import { BarChart3, CreditCard, LayoutDashboard, Settings, Tags, Users, Briefcase, UserCircle, History, Percent, Megaphone, Trash2, ScrollText } from "lucide-react";
...
const TOUS_LES_LIENS: { module: ModuleAdmin; item: SidebarNavItem }[] = [
  ...
  {
    module: "promotions",
    item: { label: "Promotions", href: "/admin/promotions", icon: <Percent className="size-4" /> },
  },
  {
    module: "visibilite_sponsorisee",
    item: {
      label: "Visibilité sponsorisée",
      href: "/admin/visibilite-sponsorisee",
  ...
  {
    module: "audit",
    item: { label: "Historique des actions", href: "/admin/audit", icon: <History className="size-4" /> },
  },
  {
    module: "journal_systeme",
    item: { label: "Journal système", href: "/admin/journal-systeme", icon: <ScrollText className="size-4" /> },
  },
  {
    module: "corbeille",
    item: { label: "Corbeille", href: "/admin/corbeille", icon: <Trash2 className="size-4" /> },
  },
];
